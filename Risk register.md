...
| Notes | *How are security events possible considering the risks the asset faces in its operating environment? Working with external companies increases data-security risk because it introduces additional points where information could be exposed or compromised. While theft is still a relevant concern, it may be considered a lower priority for the bank due to its location in a low-crime area* |  |  |  |  |
